...
public class LeafGround {
    ...
    public static void main(String[] args) {
        System.setProperty("webdriver.chrome.driver", "E:\\DSA\\chromedriver.exe");
        ...
        for (int page = 1; page <= pages; page++) {
            ...
            for (int row = 1; row <= rowCount; row++) {
                ...
                if (hashMap.containsKey(country)) {
                    ...
                    List<List<String>> countryValues = new ArrayList<>();
                    countryValues.add(values);
    ...
    private static int getColumnNumber(WebDriver driver, String columnName) {
